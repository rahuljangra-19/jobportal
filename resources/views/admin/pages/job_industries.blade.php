            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title">Job Industries Details Table</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-around"> <a href="#"
                                                    onclick="edit(`{{ $value->id }}`)"><i class="fa fa-pencil"></i></a>
                                                <a href="{{ route('delete.industry', ['id' => $value->id]) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Job Industry</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" id="title">Add new industry</h4>
                                    <form class="forms-sample" id="industry-form" method="POST">
                                        @csrf
                                        <input type="hidden" name="id" id="industry_id" value="">
...
@section('script')
    <script>
        $(document).ready(() => {
            let form = $('#industry-form');
            form.submit((e) => {
                e.preventDefault();
                console.log('submit');
                $.ajax({
                    url: `{{ route('create.industry') }}`,
                    method: 'POST',
                    ...
                    success: (response) => {
                        ...
                        if (response.status == 200) {
                            ...
                            $('#title').html(`Create new industry`);
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#industry_id').val(response.data.id);
                    $('#exampleModal').modal('toggle');

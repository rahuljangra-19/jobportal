                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-around">
                                                ...
                                                <a href="{{ route('delete.type', ['id' => $value->id]) }}"
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" id="type_title">Create new Type</h4>
                                    <form class="forms-sample" id="type-form" method="POST">
                                        @csrf
                ...
                $.ajax({
                    ...
                    success: (response) => {
                        ...
                        if (response.status == 200) {
                            ...
                            $('#type_title').html(`Create new type`);
